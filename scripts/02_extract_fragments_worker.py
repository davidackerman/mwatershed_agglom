...
def watershed_in_block(
    ...
    # extract fragments
    adjacent_edge_bias = .1 - filter_fragments #-0.4  # bias towards merging
    lr_edge_bias = -.2 - filter_fragments #-0.7  # bias heavily towards splitting
    ...
    smoothed_affs = (
        gaussian_filter(affs.data, sigma=(0, *(Coordinate(context) / 3))) - filter_fragments
    ) * 0.01
    shift = np.array(
